package com.community.project.system.company.service;
...
public interface ICompanyService 
{
    ...
    PageInfo<Company> selectCompanyWithPage(int page, int count, String musicTitle);
