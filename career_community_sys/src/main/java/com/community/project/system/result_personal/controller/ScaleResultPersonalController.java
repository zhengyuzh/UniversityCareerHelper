package com.community.project.system.result_personal.controller;
...
public class ScaleResultPersonalController extends BaseController
{
    ...
    @Log(title = "个人报告", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(ScaleUserResult scaleUserResult)
    {
        ...
        return util.exportExcel(list, "个人报告数据");
    }
    ...
    @Log(title = "个人报告", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "个人报告", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "个人报告", businessType = BusinessType.DELETE)
    @PostMapping( "/remove")
    @ResponseBody
