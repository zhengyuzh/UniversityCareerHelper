package com.community.project.system.scale.controller;
...
public class ScaleController extends BaseController
{
    ...
    @Log(title = "职业测试量表管理", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(Scale scale)
    {
        ...
        return util.exportExcel(list, "职业测试量表管理数据");
    }
    ...
    @Log(title = "职业测试量表管理", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "职业测试量表管理", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "职业测试量表管理", businessType = BusinessType.DELETE)
    @PostMapping( "/remove")
    @ResponseBody
