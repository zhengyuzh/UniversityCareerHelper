package com.community.project.system.scale.service.impl;
...
import com.community.project.system.scale.mapper.ScaleMapper;
...
public class ScaleServiceImpl implements IScaleService 
{
     ...
     * 批量删除职业测试量表管理
     * 
     * @param scaleIds 需要删除的职业测试量表管理主键
     * @return 结果
     */
    @Transactional
    @Override
