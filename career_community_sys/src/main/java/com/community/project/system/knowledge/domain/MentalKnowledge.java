package com.community.project.system.knowledge.domain;
...
public class MentalKnowledge extends BaseEntity
{
    ...
    /** 审核状态 */
    @Excel(name = "文章类型")
    private Integer mentalKnowledgeType;

    public Integer getMentalKnowledgeType() {
        return mentalKnowledgeType;
    }

    public void setMentalKnowledgeType(Integer mentalKnowledgeType) {
        this.mentalKnowledgeType = mentalKnowledgeType;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("mentalKnowledgeType", getMentalKnowledgeType())
                .toString();
    }
}